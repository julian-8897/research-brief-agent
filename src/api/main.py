...
def _final_summary(event: dict) -> dict[str, object]:
    ...
    return {
        ...
        "recency_sensitive": retrieval.get("recency_sensitive"),
        "recency_backfill_attempted": retrieval.get("recency_backfill_attempted"),
        "recent_candidates": retrieval.get("recent_candidates"),
